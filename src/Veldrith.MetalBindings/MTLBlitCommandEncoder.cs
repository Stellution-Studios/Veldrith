...
public struct MTLBlitCommandEncoder {
    ...
    public void copyFromBuffer(
        ...
        bool isMacOS) {
        if (!isMacOS) {
            copyFromBuffer_iOS(this.NativePtr,
    ...
    public void copyTextureToBuffer(
        ...
        objc_msgSend(this.NativePtr, sel_copyFromTexture0,
            sourceTexture,
            sourceSlice,
            sourceLevel,
            sourceOrigin,
    ...
    public void copyFromTexture(
        ...
        bool isMacOS) {
        if (!isMacOS) {
            copyFromTexture_iOS(this.NativePtr,
            ...
            objc_msgSend(this.NativePtr, sel_copyFromTexture1,
                sourceTexture,
                sourceSlice,
                sourceLevel,
                sourceOrigin,
