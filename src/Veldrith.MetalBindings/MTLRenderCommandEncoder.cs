...
public struct MTLRenderCommandEncoder {
    ...
    public void setVertexBuffer(MTLBuffer buffer, UIntPtr offset, UIntPtr index) {
        objc_msgSend(this.NativePtr, sel_setVertexBuffer,
            buffer.NativePtr,
            offset,
            index);
    }
    ...
    public void setVertexBufferOffset(UIntPtr offset, UIntPtr index) {
        objc_msgSend(this.NativePtr, sel_setVertexBufferOffset,
            offset,
            index);
    }

    public void setFragmentBuffer(MTLBuffer buffer, UIntPtr offset, UIntPtr index) {
        objc_msgSend(this.NativePtr, sel_setFragmentBuffer,
            buffer.NativePtr,
            offset,
            index);
    }
    ...
    public void setFragmentBufferOffset(UIntPtr offset, UIntPtr index) {
        objc_msgSend(this.NativePtr, sel_setFragmentBufferOffset,
            offset,
            index);
    }
    ...
    public void drawPrimitives(
        ...
        objc_msgSend(this.NativePtr, sel_drawPrimitives0,
    ...
    public void drawPrimitives(
        ...
        UIntPtr vertexCount,
        UIntPtr instanceCount) {
        objc_msgSend(this.NativePtr, sel_drawPrimitives2,
    ...
    public void drawPrimitives(MTLPrimitiveType primitiveType, MTLBuffer indirectBuffer, UIntPtr indirectBufferOffset) {
        objc_msgSend(this.NativePtr, sel_drawPrimitives1,
    ...
    public void drawIndexedPrimitives(
        ...
        UIntPtr instanceCount) {
        objc_msgSend(this.NativePtr, sel_drawIndexedPrimitives0,
    ...
    public void drawIndexedPrimitives(
        ...
        objc_msgSend(this.NativePtr, sel_drawIndexedPrimitives2,
            primitiveType,
            indexType,
            indexBuffer,
            indexBufferOffset,
