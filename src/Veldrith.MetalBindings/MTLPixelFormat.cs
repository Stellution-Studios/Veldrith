...
public enum MTLPixelFormat : uint {
    ...
    /// <summary>
    /// Stores the value associated with <c>Invalid</c>.
    /// </summary>
    Invalid = 0,
    ...
    /// <summary>
    /// Stores the value associated with <c>A8Unorm</c>.
    /// </summary>
    A8Unorm = 1,

    /// <summary>
    /// Stores the value associated with <c>R8Unorm</c>.
    /// </summary>
    R8Unorm = 10, R8Unorm_sRGB = 11,

    /// <summary>
    /// Stores the value associated with <c>R8Snorm</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>R16Unorm</c>.
    /// </summary>
    R16Unorm = 20, R16Snorm = 22, R16Uint = 23, R16Sint = 24, R16Float = 25,

    /// <summary>
    /// Stores the value associated with <c>RG8Unorm</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>B5G6R5Unorm</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>R32Uint</c>.
    /// </summary>
    R32Uint = 53, R32Sint = 54, R32Float = 55,

    /// <summary>
    /// Stores the value associated with <c>RG16Unorm</c>.
    /// </summary>
    RG16Unorm = 60, RG16Snorm = 62, RG16Uint = 63, RG16Sint = 64, RG16Float = 65,

    /// <summary>
    /// Stores the value associated with <c>RGBA8Unorm</c>.
    /// </summary>
    RGBA8Unorm = 70, RGBA8Unorm_sRGB = 71, RGBA8Snorm = 72, RGBA8Uint = 73, RGBA8Sint = 74,

    /// <summary>
    /// Stores the value associated with <c>BGRA8Unorm</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>RGB10A2Unorm</c>.
    /// </summary>
    RGB10A2Unorm = 90, RGB10A2Uint = 91,

    /// <summary>
    /// Stores the value associated with <c>RG11B10Float</c>.
    /// </summary>
    RG11B10Float = 92, RGB9E5Float = 93,

    /// <summary>
    /// Stores the value associated with <c>BGR10_XR</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>RG32Uint</c>.
    /// </summary>
    RG32Uint = 103, RG32Sint = 104, RG32Float = 105,

    /// <summary>
    /// Stores the value associated with <c>RGBA16Unorm</c>.
    /// </summary>
    RGBA16Unorm = 110, RGBA16Snorm = 112, RGBA16Uint = 113, RGBA16Sint = 114, RGBA16Float = 115,

    /// <summary>
    /// Stores the value associated with <c>BGRA10_XR</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>RGBA32Uint</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>BC1_RGBA</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>BC4_RUnorm</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>BC6H_RGBFloat</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>PVRTC_RGB_2BPP</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>ASTC_4x4_sRGB</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>ASTC_4x4_LDR</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>GBGR422</c>.
    /// </summary>
    GBGR422 = 240,
    ...
    /// <summary>
    /// Stores the value associated with <c>BGRG422</c>.
    /// </summary>
    BGRG422 = 241,
    ...
    /// <summary>
    /// Stores the value associated with <c>Depth16Unorm</c>.
    /// </summary>
    ...
    /// <summary>
    /// Stores the value associated with <c>Stencil8</c>.
    /// </summary>
    Stencil8 = 253,
    ...
    /// <summary>
    /// Stores the value associated with <c>Depth24Unorm_Stencil8</c>.
    /// </summary>
    Depth24Unorm_Stencil8 = 255, Depth32Float_Stencil8 = 260,

    /// <summary>
    /// Stores the value associated with <c>X32_Stencil8</c>.
    /// </summary>
