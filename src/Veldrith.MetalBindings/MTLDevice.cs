...
public unsafe struct MTLDevice {
    ...
    public MTLLibrary newLibraryWithSource(string source, MTLCompileOptions options) {
        ...
        IntPtr library = IntPtr_objc_msgSend(this.NativePtr, sel_newLibraryWithSource,
            sourceNSS,
            options,
            out NSError error);
    ...
    public MTLRenderPipelineState newRenderPipelineStateWithDescriptor(MTLRenderPipelineDescriptor desc) {
        IntPtr ret = IntPtr_objc_msgSend(this.NativePtr, sel_newRenderPipelineStateWithDescriptor,
            desc.NativePtr,
            out NSError error);
    ...
    public MTLComputePipelineState newComputePipelineStateWithDescriptor(
        ...
        IntPtr ret = IntPtr_objc_msgSend(this.NativePtr, sel_newComputePipelineStateWithDescriptor,
            descriptor,
            0,
            IntPtr.Zero,
            out NSError error);
    ...
    public MTLBuffer newBuffer(void* pointer, UIntPtr length, MTLResourceOptions options) {
        IntPtr buffer = IntPtr_objc_msgSend(this.NativePtr, sel_newBufferWithBytes,
            pointer,
            length,
            options);
