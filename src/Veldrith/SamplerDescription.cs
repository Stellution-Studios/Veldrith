...
public struct SamplerDescription : IEquatable<SamplerDescription> {
    ...
    public override int GetHashCode() {
        return HashHelper.Combine(
            (int)this.AddressModeU,
            (int)this.AddressModeV,
            (int)this.AddressModeW,
            (int)this.Filter, this.ComparisonKind.GetHashCode(), this.MaximumAnisotropy.GetHashCode(),
            this.MinimumLod.GetHashCode(), this.MaximumLod.GetHashCode(), this.LodBias.GetHashCode(),
            (int)this.BorderColor);
    }
}