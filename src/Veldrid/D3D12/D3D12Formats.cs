...
namespace Veldrid.D3D12
{
    internal static class D3D12Formats
    {
        ...
        internal static Vortice.Direct3D.PrimitiveTopology ToD3DPrimitiveTopology(VdPrimitiveTopology topology)
        {
            switch (topology)
            {
                case VdPrimitiveTopology.TriangleList: return Vortice.Direct3D.PrimitiveTopology.TriangleList;
                case VdPrimitiveTopology.TriangleStrip: return Vortice.Direct3D.PrimitiveTopology.TriangleStrip;
                case VdPrimitiveTopology.LineList: return Vortice.Direct3D.PrimitiveTopology.LineList;
                case VdPrimitiveTopology.LineStrip: return Vortice.Direct3D.PrimitiveTopology.LineStrip;
                case VdPrimitiveTopology.PointList: return Vortice.Direct3D.PrimitiveTopology.PointList;
                default: throw Illegal.Value<VdPrimitiveTopology>();
            }
        }

        internal static PrimitiveTopologyType ToPrimitiveTopologyType(VdPrimitiveTopology topology)
        {
            switch (topology)
            {
                case VdPrimitiveTopology.TriangleList:
                case VdPrimitiveTopology.TriangleStrip:
                    return PrimitiveTopologyType.Triangle;
                case VdPrimitiveTopology.LineList:
                case VdPrimitiveTopology.LineStrip:
                    return PrimitiveTopologyType.Line;
                case VdPrimitiveTopology.PointList:
                    return PrimitiveTopologyType.Point;
                default:
                    throw Illegal.Value<VdPrimitiveTopology>();
            }
        }
        ...
        internal static ColorWriteEnable ToColorWriteMask(ColorWriteMask mask)
        {
            ...
            if ((mask & ColorWriteMask.Red) == ColorWriteMask.Red) enable |= ColorWriteEnable.Red;
            if ((mask & ColorWriteMask.Green) == ColorWriteMask.Green) enable |= ColorWriteEnable.Green;
            if ((mask & ColorWriteMask.Blue) == ColorWriteMask.Blue) enable |= ColorWriteEnable.Blue;
            if ((mask & ColorWriteMask.Alpha) == ColorWriteMask.Alpha) enable |= ColorWriteEnable.Alpha;
            return enable;
        }
        ...
        internal static Color4 ToBorderColor(SamplerBorderColor color)
        {
            switch (color)
            {
                ...
                case SamplerBorderColor.OpaqueBlack: return new Color4(0f, 0f, 0f, 1f);
                case SamplerBorderColor.OpaqueWhite: return new Color4(1f, 1f, 1f, 1f);
